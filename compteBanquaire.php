...
class compteBanque{
    ...
    public function setSoldeInitial(string $soldeInitial){
        $this->_soldeInitial = $soldeInitial;
    }
    ...
    public function getTitulairee(): string{
    ...
    public function crediter(float $sommeAjouter){
    ...
    public function debiter(float $sommeRetirer){
    ...
    public function virement(compteBanque $compteDestinataire, float  $sommeVirer){
        $this->debiter($sommeVirer);
        $compteDestinataire->crediter($sommeVirer);
        return "Vous avez fait un virement de $sommeVirer $this->_deviseMonetaire de votre compte  $this->_libelle a votre compte $compteDestinataire->_libelle ";
    }
